...
>Part one is a table of recent `r topic` related bills. Part two gives information on the `r bill_name`. Part three gives information about my local representative, `r name`. 
