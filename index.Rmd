...
What bill are you describing? Include any relevant details (e.g., title, sponsors, etc.) using inline R code in case they change later. Be sure and include a link to the bill's full text!
...
A list or table of recent bills the representative has sponsored or cosponsored, so you know what they have been trying to accomplish. You only need to include the bill titles and identifiers.
