...
> Part one is a table of recent tax related bills. Part two is information on the `r bill_name`. Part three is information about my local representative, `r name`. 
...
> The Senate and the House introduce and amend their own versions of a bill they want to pass, but the Senate and the House must vote on and pass the same version of a bill.
...
- The bill prohibits cellphone use and voice communications while in-flight
